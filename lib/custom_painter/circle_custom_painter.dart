...
class CircleCustomPaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 20; i++) {
      canvas.drawArc(const Rect.fromLTWH(80.0, 42.0, 230, 230), gap + singleAngle * i, singleAngle - gap * 2, false, firstCirclePaint);
    }
...
class ThirdCirclePaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    /*var firstCirclePaint = Paint()
      ...
      ..color = Colors.white
      ..style = PaintingStyle.stroke;
    canvas.drawCircle(const Offset(300, 38), 25, firstCirclePaint);*/
